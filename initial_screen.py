...
class initial_screen(ctk.CTk):
    ...
    def start_screen(self):
        ...
        self.top_label0 = ctk.CTkLabel(self,height = 100,text = "HMS APPOINTMENT BOOKING",fg_color = "#B8B8B8",text_color = "#000000",font = ctk.CTkFont(family = "Helvetica",size = 30,weight = "bold"))
